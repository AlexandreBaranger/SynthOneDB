...
def normalize_audio(input_file, output_file):
    ...
    # Commande FFmpeg pour la normalisation avec loudness range target à -18 LUFS et conversion en mono
    command = [ffmpeg_path, '-i', input_file, '-af', 'loudnorm=I=-9:LRA=11:tp=-2,pan=mono|c0=.5*c0+.5*c1', '-ar', '96000', '-acodec', 'pcm_s24le', output_file]
